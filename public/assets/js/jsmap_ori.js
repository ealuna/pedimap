...
var socket = io.connect('/oriunda/reportes', {'forceNew': true});
...
function cargarDespachos(fecha, fletero) {
    $.ajax({
        type: 'POST',
        url: '/oriunda/app/reporte/despacho',
...
function createPDF() {
    ...
    html2canvas(element, {
        ...
        onrendered: function (canvas) {
            var img = canvas.toDataURL('/oriunda/assets/img');
            var pdf = new jsPDF();
